...
<head>
    ...
    <style type="text/css">
        #base{ margin:0 auto;width:480px;text-align: center;margin-top:200px;}
        ul{padding:0px;margin:0px;list-style:none;}
       .label_field,.label_input,.error_span{display:block;padding-top:10px;padding-bottom:5px;float:left;height:25px;width:150px;padding-bootom:5px;padding-top:5px;}
        #main{border:solid 1px #1B3160;float:left;}
        #main li{width:478px;float:left;   }
        h2{padding-top:5px;padding-bottom:5px;text-align:center;margin:0px;color:#fff;}
        .error_span{padding-left:20px;font-size:13px;}

        .base{background-color: #1c6a9e;padding:0px;margin:0px;}
           ...
           function stRegist(){
               ...
               if(username==""){
                   ...
                   if(!reg.test(username)||!isNaN(reg)){
                       document.getElementById("username_alt").innerHTML="格式错误！A-Za-z0-9 组成，8-12位";
                       return;
                   }
...
<div id="base" class="base" >
     ...
     <form action="<%=basePath%>StudentLoginControl" method="post" id="registForm">
         <ul id="main">
             <li>
